...
| 文件 | 类型 | 说明 |
|------|------|------|
| `MarkDown-editor_0.2.1_x64-setup.exe` | 安装包联网版 | 双击安装到电脑，联网时检查更新 |
| `MarkDown-editor_0.2.1_portable.exe` | 便携版本地版 | 免安装，可完全离线 |
| `MarkDown-editor.portable` | 标记文件 | 与便携版 exe 放在同一目录 |
| `INSTALL.zh-CN.txt` | 说明 | 中文安装说明 |

下载地址：<https://github.com/Gran129/MarkDown-editor/releases/tag/v0.2.1>
